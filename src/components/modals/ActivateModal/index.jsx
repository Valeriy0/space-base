...
export const ActivateModal = ({ openedModal, handleCloseModal }) => {
  ...
  return (
      <Modal  isOpened={openedModal} onClose={handleCloseModal}>
        <div className="flex flex-col items-center justify-center bg-[#141517] border border-[1px] border-white-100 w-[480px] rounded-3xl sm:rounded-none sm:rounded-t-3xl py-[40px] space-y-10 px-[40px] sm:w-full">
